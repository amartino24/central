...
<head>
    ...
    <link rel="mask-icon" href="<?php echo get_template_directory_uri(); ?>/imagenes/favicon/safari-pinned-tab.svg" color="#5bbad5">
    ...
    <div class=" banner-container  bg-white azul-fg">
        <div class="container flex a-center j-between">
            ...
            <a href="<?php echo get_template_directory_uri(); ?>/index.html">
                <img id='main-escudo' class="main-escudo" src="<?php echo get_template_directory_uri(); ?>/imagenes/escudo.png">
            </a>
            <div class="enlaces-externos flex a-center">
                ...
                <div class="enlace  over-yellow  flex a-center">
                    ...
                    <span class="text"><b>TIENDA</b>ONLINE</span>
                </div>
                <div class="enlace over-yellow flex a-center"> <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span class="text">SEDE<b>VIRTUAL</b></span>
                </div>
            </div>
        </div>
        ...
        <div class="container flex j-between">
            <div class="post-principal azul-fg  br-20">
                ...
                <div class="flex header-info">
                    <a class="pointer amarillo-fg bold category">DIVISIONES INFERIORES</a>
                    <span class="gris-fg fecha">2 de Enero de 2021 - 15h</span>
                ...
                <div class="content flex-column">
                    ...
                    <p class="text azul-secundario-fg">La historia entre Marco Ruben y Rosario Central tiene un capítulo más. Este
                        lunes, nuestro goleador -que tomó la decisión de regresar a la Institución hace algunos
                        días- firmó su nuevo contrato con el Canalla por un año.
                        <br>
                        <br>
                        De esta manera, Marco da inicio a su cuarto ciclo como futbolista auriazul. El delantero ya
                        había vestido la camiseta más linda de todas, entre 2004 y 2016, de 2015 a 2018 y en 2020.
                        <br>
                        <br>
                        Además de su amor Gigante por Central, hay muchas otras cosas para resaltar de la historia
                        de Ruben en el Club. Fue campeón de la Copa Argentina 2018, goleador del Torneo de Primera
                        División 2015, protagonista principal de varios Clásicos (le anotó cuatro veces a Newell's,
                        dos de local y de visitante en cuatro cotejos que culminaron con victoria) y autor de gran
                        cantidad de tantos vistiendo la casaca auriazul.
                        <br>
                        <br>
                        Desde su debut, el 25 de agosto de 2004 (empate sin goles ante Quilmes) hasta su partido más
                        reciente, el 16 de marzo de 2020 ante Colón (1-3 por Copa de la Superliga), Marco acumula
                        214 partidos en nuestro Club y lleva anotados, nada menos que 81 goles, los cuales lo ubican
                        entre los diez máximos anotadores de la historia auriazul.

                        <br>
                        <br>
                        ¡Aguardamos con ansias el regreso del fútbol para volverte a ver con la 9 de Central!
                    </p>
                </div>
            ...
            <div class="posts-carousel owl-carousel" id="otros-posts-carousel">
                <div class="post  br-20">
                    ...
                    <div class="info flex-column j-center">
                        ...
                        <a class="ver-mas azul-claro-fg">VER MÁS <svg xmlns="http://www.w3.org/2000/svg" width="20.559"
                                                                      height="13.711" viewBox="0 0 20.559 13.711">
                                <path id="Icon_ionic-ios-arrow-round-forward"
                                      data-name="Icon ionic-ios-arrow-round-forward"
                                      d="M20.986,11.514a.933.933,0,0,0-.007,1.314l4.342,4.349H8.8a.928.928,0,0,0,0,1.857H25.313l-4.342,4.349a.94.94,0,0,0,.007,1.314.925.925,0,0,0,1.307-.007l5.884-5.927h0a1.042,1.042,0,0,0,.193-.293.886.886,0,0,0,.071-.357.931.931,0,0,0-.264-.65l-5.884-5.927A.91.91,0,0,0,20.986,11.514Z"
        ...
        <div class="footer-navigation flex a-center j-between">
            ...
            <div class="flex a-center">
                ...
                <div class="social flex a-center j-between grow">
                    ...
                    <div class="tiktok" title="Seguinos en Tiktok"></div>
                    <div class="facebook" title="Seguinos en Facebook"></div>
                    <div class="twitter" title="Seguinos en Twiiter"></div>
                    <div class="instagram" title="Seguinos en Instagram"></div>
                    <div class="youtube" title="Seguinos en Youtube"></div>
