...
<div class='plantilla page bg-grey'>
    ...
    <span class="azul-claro-fg plantel-label">PLANTEL PROFESIONAL</span>
    </div>
    </div>
    <section class='slider-jugadores bg-dark-blue owl-carousel' id="plantilla-jugadores-carousel">
            <?php
